...
<input type="hidden"  class="form-control" id="FECHA" name="FECHA" value="<?php echo $fecha ?>" >       
      ...
      <input value="<?php echo $filas ['ID_CLIENTE']; ?>" class="form-control" list="CLIENTES" type="text" id="ID_CLIENTE" name="ID_CLIENTE" required>
      ...
      <td>
        <input type="times" class="form-control" id="H_CITA" name="H_CITA" value="<?php echo $filas ['H_CITA']  ?>" required>
...
<td>
    <a href="crud_programacion/delete.php?id=<?php echo $filas['Id_SERG']?>&f=<?php echo $fecha ?>" class="btn btn-danger btn-sm" style="display: inline-block;"> 
