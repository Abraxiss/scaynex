...
<form action="crud_tablas/update.php" method="POST">
  ...
  <div class="form-group">
    <label for="TIPO_CARGA">TIPO_CARGA:</label>
    <input type="text" class="form-control" id="TIPO_CARGA" name="TIPO_CARGA" placeholder="TIPO_CARGA" value="<?php echo $filas ['TIPO_CARGA']; ?>">
  </div>
...
<form action="crud_tablas/create.php" method="POST">
  ...
  <div class="form-group">
    <label for="TIPO_CARGA">TIPO_CARGA:</label>
    <input type="text" class="form-control" id="TIPO_CARGA" name="TIPO_CARGA" placeholder="TIPO_CARGA" >
  </div>
